d3 = function() {
  ...
  var d3_geo_clipAntimeridian = d3_geo_clip(d3_geo_clipAntimeridianVisible, d3_geo_clipAntimeridianLine, d3_geo_clipAntimeridianInterpolate, [ -π, -π / 2 ], d3_geo_clipAntimeridianSort);
  ...
  function d3_geo_clipCircle(radius) {
    ...
    return d3_geo_clip(visible, clipLine, interpolate, smallRadius ? [ 0, -radius ] : [ -π, radius - π ], d3_geo_clipAntimeridianSort);
