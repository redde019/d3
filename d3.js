d3 = function() {
  ...
  function d3_geom_voronoiCloseCells(extent) {
    var x0 = extent[0][0], x1 = extent[1][0], y0 = extent[0][1], y1 = extent[1][1], x2, y2, x3, y3, cells = d3_geom_voronoiCells, iCell = cells.length, cell, iLeft, iRight, halfEdges, nHalfEdges, edge, start, end;
    while (iCell--) {
      cell = cells[iCell];
      ...
      while (iLeft < nHalfEdges) {
        ...
        start = halfEdges[iRight].start(), x2 = start[0], y2 = start[1];
        end = halfEdges[iLeft].end(), x3 = end[0], y3 = end[1];
